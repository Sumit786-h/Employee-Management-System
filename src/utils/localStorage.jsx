...
const seedEmployees = [
  {
    ...
    email: "e@e.com",
    password: "123",
    taskCounts: { active: 0, newTask: 0, completed: 2, failed: 1 },
    tasks: [
      {
...
const seedAdmin = [{ id: 1, email: "admin@example.com", password: "123" }];

export const setLocalStorage = () => {
  if (!localStorage.getItem("employees")) {
    localStorage.setItem("employees", JSON.stringify(seedEmployees));
  }
  if (!localStorage.getItem("admin")) {
    localStorage.setItem("admin", JSON.stringify(seedAdmin));
  }
};
